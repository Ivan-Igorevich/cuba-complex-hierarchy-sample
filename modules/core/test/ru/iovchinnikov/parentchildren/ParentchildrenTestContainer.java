package ru.iovchinnikov.parentchildren;
...
public class ParentchildrenTestContainer extends TestContainer {

    public ParentchildrenTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "ru/iovchinnikov/parentchildren/app.properties",
    ...
    public static class Common extends ParentchildrenTestContainer {

        public static final ParentchildrenTestContainer.Common INSTANCE = new ParentchildrenTestContainer.Common();
